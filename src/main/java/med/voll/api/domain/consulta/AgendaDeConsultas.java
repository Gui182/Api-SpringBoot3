...
public class AgendaDeConsultas {
    ...
    public DadosDetalhamentoConsulta agendar(DadosAgendamentoConsulta dados) {
        ...
        if(medico == null) {
            throw new ValidacaoException("Médico não disponivel para essa data");
        }
    ...
    private Medico escolherMedico(DadosAgendamentoConsulta dados) {
        ...
        if(dados.especialidade() == null) {
            throw new ValidacaoException("Especialidade é obrigátorio quando não houver médico");
        }

        return medicoRepository.escolherMedicoAlatorioLivreNaData(dados.especialidade(), dados.data());
    }
}
